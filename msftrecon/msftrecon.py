    ...
    def run_all_checks(self) -> Dict:
        ...
        # if tenant_id:
            ...
            results["tenant_config"] = {
                "branding": fed_info.get("TenantBrandingInfo")[0] if fed_info and "TenantBrandingInfo" in fed_info and len(fed_info.get("TenantBrandingInfo")) > 0 else None,
                ...
                "keep_me_signed_in": not bool(fed_info.get("TenantBrandingInfo")[0].get("KeepMeSignedInDisabled")) if fed_info and "TenantBrandingInfo" in fed_info and len(fed_info.get("TenantBrandingInfo")) > 0 else None
            }
        else:
            results = {}
